...
class AdicionarAoCarrinho(View):
    def get(self, *args, **kwargs):
        ...
        messages.success(
            self.request,
            f"O produto {produto_nome} {variacao_nome} adicionado ao seu carrinho",
        )
        return redirect(http_referer)
...
class Carrinho(View):
    def get(self, *args, **kwargs):
        carrinho = {"carrinho": self.request.session.get("carrinho", {})}
        return render(self.request, "produto/carrinho.html", carrinho)
